...
def remove_unwanted_characters(input_string, allowed_characters):
    # Create a regex pattern that matches any character not in the allowed list
...
allowed_characters = [""] # provide characters
cleaned_string = remove_unwanted_characters(input_string, allowed_characters)
print(cleaned_string)  # Output: Hex